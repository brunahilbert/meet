 ...
 * this is set to read only for now because you don't have access rights to update the calendar yourself.
 ...
 * The “process.env”  means the value is in the “config.json” file.
...
const credentials = {
  ...
  redirect_uris: ['https://brunahilbert.github.io/meet/'],
  javascript_origins: [
 ...
 * Google and be authorized to see your calendar events data.
